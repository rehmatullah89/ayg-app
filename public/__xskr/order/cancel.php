<?php
	...
	$json_url = '../process/?action=orderCancel&tokenEpoch=' . $epoch . '&token=' . $token . '&orderId=' . $_GET['orderId'];
?>
<!DOCTYPE html>
<html>
<head>
	<!-- META -->
	<title>Order - Cancel Request</title>
	<meta charset="UTF-8">
...
<div class="grid">
	<table class="noborder" cellspacing="0" cellpadding="0">
	  <thead>
		<tr>
		  <th>
			<h4>Orders Cancellation Request</h4>
<?php
	  ...
	  <tbody>
		...
		<form id="cancelRequest">
			...
			<div id="link-wrapper-extraoptions" style="display: none">
				<a class="small blue button" href="index.php"><i class="fa"></i> BACK TO ORDERS</a>
			...
			<div id="link-wrapper-button">
				...
				<input type="hidden" value="<?php echo($_GET['orderId']); ?>" name="orderId">
		 		<br /><br />
				<a class="small blue button" href="index.php");return false;"><i class="fa"></i> BACK TO ORDERS</a>
