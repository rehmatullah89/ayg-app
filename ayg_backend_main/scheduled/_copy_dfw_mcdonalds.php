...
$dir = __DIR__.'/dfwmcdcopy';

$date = new DateTime('now',new DateTimeZone('UTC'));
$fileName = $date->format('Y-m-d-H-i-s').'.json';
$x=file_get_contents('https://grabmobilewebtop.com/Cursus/Cursus_PartnerDirect_GetStoreInventory?email=grab@atyourgate.com&storeWaypointID=33700&kobp=dc1269c8a373e2aed8596a974f5d093a');
