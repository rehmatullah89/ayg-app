...
/**
 * Class ConsumerIntegrationTripItRevokeAccessTest
 *
 * tested endpoint:
 * // Revoke TripIt Access
 * '/integrations/tripIt/revokeAccess/a/:apikey/e/:epoch/u/:sessionToken'
 ...
 */
class ConsumerIntegrationTripItRevokeAccessTest extends ConsumerBaseTest
{
     ...
     *
     */
    public function t_estThatTripItAccountCanBeRevoked()
    {
        ...
        $this->assertArrayHasKey('revoked', $arrayJsonDecodedBody);
    ...
    public function testThatTripItRequestTokenCanNotBeRequestedWithBadSessionToken()
    {
        ...
        $url = $this->generatePath('integrations/tripIt/revokeAccess', $sessionToken, "");
