 ...
 */
class ConsumerRetailerFullfillmentInfoRetailerIdTest extends ConsumerBaseTest
{
    ...
    public function testThatListCanBeTaken()
    {
        ...
        $retailerId = '0';
        $url = $this->generatePath('retailer/fullfillmentInfo', $user->getSessionToken(), "airportIataCode/$airportIataCode/locationId/$locationId/retailerId/$retailerId");
    ...
    public function testThatListCanNotBeTakenWithBadSessionToken()
    {
        ...
        $locationId = 'A5NYnxOiJF';
        $retailerId = '0';
        $url = $this->generatePath('retailer/fullfillmentInfo', $sessionToken, "airportIataCode/$airportIataCode/locationId/$locationId/retailerId/$retailerId");
