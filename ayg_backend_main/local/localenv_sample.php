...
putenv("env_EnvironmentDisplayCode=DEV");
putenv("env_EnvironmentDisplayCodeNoProd=DEV"); // Leave Empty for Prod

// Back4App
putenv("env_ParseApplicationId=");
putenv("env_ParseMasterKey=");
putenv("env_ParseRestAPIKey=");
putenv("env_ParseServerURL=h");
...
putenv("env_DeliveryFeesInCentsDefault=499");
...
putenv("env_S3BucketName=");
putenv("env_S3Endpoint=");


putenv("env_S3LogsAccessKey=");
putenv("env_S3LogsAccessSecret=");
putenv("env_S3LogsBucketName=");
putenv("env_S3LogsRegion=");
...
putenv("env_SlackWH_orderForcedClosed=https://hooks.slack.com/services///");
putenv("env_SlackWH_orderInvPrintDelay=https://hooks.slack.com/services///");
putenv("env_SlackWH_orderNotifications=https://hooks.slack.com/services///");
putenv("env_SlackWH_orderProcErrors=https://hooks.slack.com/services///");
putenv("env_SlackWH_ordersBalVariance=https://hooks.slack.com/services///");
putenv("env_SlackWH_posPingFail=https://hooks.slack.com/services///");
putenv("env_SlackWH_deliveryPingFail=https://hooks.slack.com/services///");

putenv("env_SlackWH_bugReports=https://hooks.slack.com/services///");
putenv("env_SlackWH_contactForm=https://hooks.slack.com/services//");
putenv("env_SlackWH_newUserSignup=https://hooks.slack.com/services///");
putenv("env_SlackWH_orderHelp=https://hooks.slack.com/services///");
putenv("env_SlackWH_counterAlerts=https://hooks.slack.com/services///");
putenv("env_SlackWH_deadletterAlerts=https://hooks.slack.com/services///");

putenv('env_SlackWH_userActions=https://hooks.slack.com/services///');
putenv('env_SlackWH_menuUpdates=https://hooks.slack.com/services///');
...
putenv("env_PaymentResponseEncryptionKey=");
putenv("env_PaymentResponseEncryptionKeyIos=");
putenv("env_PaymentResponseEncryptionKeyAndroid=");
putenv("env_PaymentResponseEncryptionKeyWebsite=");

putenv("env_TokenEncryptionKey=");
putenv("env_TokenEncryptionKeyIos=");
putenv("env_TokenEncryptionKeyAndroid=");
putenv("env_TokenEncryptionKeyWebsite=");

putenv("env_StringInMotionEncryptionKey=");
putenv("env_StringInMotionEncryptionKeyIos=");
putenv("env_StringInMotionEncryptionKeyAndroid=");
putenv("env_StringInMotionEncryptionKeyWebsite=");

putenv("env_AppRestAPIKeySalt=");
putenv("env_AppRestAPIKeySaltIos=");
putenv("env_AppRestAPIKeySaltAndroid=");
putenv("env_AppRestAPIKeySaltWebsite=");
...
putenv("env_RestAPITokenExpiryInMins=");
...
putenv("env_FlightStatsAppId=1c0e8b61");
putenv("env_FlightStatsAppKey=2b006abc6b9b9f229a3da9acfbf4b4fd");

// FlightAware settings
putenv("env_FlightAwareUsername=app@atyourgate.com");
putenv("env_FlightAwareAppKey=982d4c40d92a4f00c2ddf23d06959c134bcce180");
...
putenv("env_RabbitMQConfig="); // No need
putenv("env_RabbitMQConfigUseSSL=false");
putenv("env_RabbitMQConsumerPrimaryQueueName=");
putenv("env_RabbitMQAPIUrl=");
putenv("env_RabbitMQDeliveryPrimaryQueueName=");
putenv("env_RabbitMQDeliveryDeadLetterQueueName=");
...
putenv("env_NoPingCheckForDeliveryUser=true");


putenv("env_RetailerEarlyCloseMinWaitInSecs=300");


putenv("env_mysqlLogsDataBaseHost=");
putenv("env_mysqlLogsDataBaseName=");
putenv("env_mysqlLogsDataBaseUser=");
putenv("env_mysqlLogsDataBasePassword=");
putenv("env_mysqlLogsDataBasePort=3306");

putenv('env_mysqlDataDataBaseHost=');
putenv('env_mysqlDataDataBaseName=');
putenv('env_mysqlDataDataBaseUser=');
putenv('env_mysqlDataDataBasePassword=');
putenv('env_mysqlDataDataBasePort=3306');
...
putenv("env_APIKeyMaxUsage=300000");
...
putenv('env_UserReferralRulesLink=https://www.atyourgate.com');
...
putenv('env_ZendeskCreateTickets=false');
...
putenv('env_ClearPromoEnabled=true');

putenv('env_invoice_cc_email=ludwik@atyourgate.com');


putenv('env_data_edit_notification_slack_webhook_url=https://hooks.slack.com/services///');
putenv('env_retailer_edit_notification_slack_webhook_url=https://hooks.slack.com/services///');
putenv('env_coupons_edit_notification_slack_webhook_url=https://hooks.slack.com/services///');


putenv("env_RabbitMQConsumerDataEdit=");
putenv("env_RabbitMQConsumerRetailersEdit=");
putenv("env_RabbitMQConsumerCouponsEdit=");

putenv('env_MenuUploadAWSS3AccessId=');
putenv('env_MenuUploadAWSS3Secret=');
putenv('env_MenuUploadAWSS3Region=');
putenv('env_MenuUploadAWSS3Bucket=');


putenv('env_SessionTokenHashSalt=');


putenv('env_mysqlSessionsDataBaseHost=');
putenv('env_mysqlSessionsDataBaseName=');
putenv('env_mysqlSessionsDataBaseUser=');
putenv('env_mysqlSessionsDataBasePassword=');
putenv('env_mysqlSessionsDataBasePort=');


putenv('env_DeliveryStringInMotionEncryptionKey');
putenv('env_DeliveryAppDefaultPingIntervalInSecs=');
putenv('env_DeliveryAppDefaultNotificationSoundUrl=');
putenv('env_DeliveryAppDefaultVibrateUsage=');
putenv('env_DeliveryBatteryCheckIntervalInSecs=');
putenv('env_DeliveryRestAPIKeySalt=');
