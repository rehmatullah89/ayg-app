...
class User extends Entity implements \JsonSerializable
{
    ...
    public function __construct(array $data)
    {
        ...
        $this->hasTabletPOSAccess = $data['hasTabletPOSAccess'];
     ...
     * @return bool
     */
    public function isHasTabletPOSAccess()
    {
        return $this->hasTabletPOSAccess;
    }

    /**
     * @return bool
     */
    public function isHasDeliveryPOSAccess()
    {
