...
class Order extends Entity implements \JsonSerializable
{
    ...
    const STATUS_DELIVERY_ACTIVE_LIST = [
        self::STATUS_DELIVERY_NOT_PROCESSED,
        self::STATUS_DELIVERY_BEING_ASSIGNED,
        self::STATUS_DELIVERY_ASSIGNED,
        self::STATUS_DELIVERY_ARRIVED_AT_RETAILER,
        self::STATUS_DELIVERY_PICKED_UP,
        self::STATUS_DELIVERY_ARRIVED_AT_CUSTOMER_PLACE,
    ];

    const STATUS_DELIVERY_COMPLETED_LIST = [
        self::STATUS_DELIVERY_DELIVERED,
    ];

    const STATUS_FOR_DELIVERY_ALL_LIST = [
    ...
    public function __construct(array $data)
    {
        ...
        $this->retailerEtaTimestamp = $data['retailerEtaTimestamp'];
     ...
     * @return $this
     */
    public function setDeliveryLocation(TerminalGateMap $terminalGateMap)
    {
     ...
     * @return mixed
     */
    public function getRetailerEtaTimestamp()
    {
        return $this->retailerEtaTimestamp;
    }
