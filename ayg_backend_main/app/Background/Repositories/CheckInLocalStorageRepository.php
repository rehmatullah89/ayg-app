 ...
 */
class CheckInLocalStorageRepository extends LocalStorageRepository implements CheckInRepositoryInterface
{
     ...
     */
    public function logUserCheckin(string $userId, string $sessionObjectId): void
    {
        $nearAirportIataCode = "";
