 ...
 */
class UserActionLogS3Repository extends S3Repository implements UserActionLogRepositoryInterface
{
     ...
     * @param $timestamp
     */
    public function logUserAction($objectId, $action, $data, $location, $timestamp): void
    {
            ...
            $userActionLog = new UserActionLog($objectId, $action, $data, $timestamp, $timeTimezoneShort, $timeSecondOfHour, $timeMinuteOfHour, $timeHourOfDay, $timeDayOfWeekName, $timeDayOfWeek, $timeDayOfMonth, $timeMonthName, $timeMonth, $timeYear, $state,$country,$nearAirportIataCode,$locationSource);
