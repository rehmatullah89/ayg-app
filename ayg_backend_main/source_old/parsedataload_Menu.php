<?php
	...
	$filePath = './dummy/restaurant1/Restaurant 1'; // Must end in double slash
	$imagesPath = 'D:\Cloud\Google Drive\Airport Sherpa\Airport Sherpa Operations (newest)\00 - ' . $airportIataCode . ' Onboarding\\';
		...
		$imagesIndexesWithPaths = array(
				"0" => array(
								"itemImageURL" => [
									...
									"imagePath" => $imagesPath . $currentRetailer["imagePath"]
									]
							),
				"1" => array(),
				"2" => array(),
