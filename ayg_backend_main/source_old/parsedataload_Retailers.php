<?php
	...
	$airportIataCode = 'BWI'; // <<<<<<<<<<<<<<<<<<<< UPDATE;

	/////////////////////////////////////////////////////////////////////////////////////////////

	$fileArray = array_map('str_getcsv', file('<path_to_files>' . $airportIataCode . '\data\Retailers - test.csv'));
	...
	$imagesIndexesWithPaths = array(
			"imageLogo" => [
					...
					"imagePath" => '<path_to_files>' . $airportIataCode .'\imageLogo'],
			"imageBackground" => [
					...
					"maxHeight" => '',
					"createThumbnail" => false,
					"imagePath" => '<path_to_files>' . $airportIataCode .'\imageBackground',]
	);
