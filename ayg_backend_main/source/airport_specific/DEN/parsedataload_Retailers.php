...
$airportIataCode=substr($x[1],0,3);
	...
	$fileArray = array_map('str_getcsv', file('./airport_specific/'.$airportIataCode.'/'.$airportIataCode.'-data/'.$airportIataCode.'-Retailers.csv'));
	...
	$imagesIndexesWithPaths = array(
			"imageLogo" => [
					...
					"imagePath" => './airport_specific/'.$airportIataCode.'/'.$airportIataCode.'-imageLogo'],
			"imageBackground" => [
					...
					"maxHeight" => '',
					"createThumbnail" => false,
					"imagePath" => './airport_specific/'.$airportIataCode.'/'.$airportIataCode.'-imageBackground',]
	);
