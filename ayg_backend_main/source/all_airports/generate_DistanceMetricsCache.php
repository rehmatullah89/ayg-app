...
function rebuildDistanceAndDirectionsCache() {
    ...
    $airports = parseExecuteQuery(["__CONTAINEDIN__airportIataCode" => ["PDX"]], "Airports", "airportIataCode", '', [], 1000, true);
    //$airports = parseExecuteQuery(["isReady" => true], "Airports", "airportIataCode", '', [], 1000, true);

	foreach($airports as $airport) {

		// Rebuild terminal gavte map cache
