 ...
 * @return float
 */
function identifyDeliveryAvailablePercentageByDay($startDateTimeTimestamp, $endDateTimeTimestamp, $deliveryIds)
{
    ...
    try {
        list($lostPercentage, $missedPings) = $reportServiceFactory->getLostDeliveryPingPercentageForAGivenTimeRange($deliveryIds, $startDateTimeTimestamp, $endDateTimeTimestamp, $expectedPingInterval);
